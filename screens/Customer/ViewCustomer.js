...
class ViewCustomer extends Component {
    constructor(props) {
        ...
        this.state = {
            tableHead: ['Id', 'Name', 'Phone', 'Sex', 'Balance', 'Purchase', 'View', 'Edit', 'Delete'],
            widthArr: [40, 60, 60, 100, 80, 100, 100, 100, 100],
            tableData: [
                ['1', 'John', '1202311', 'Male', '0.00',  elementButton('purchase'), elementButton('view'), elementButton('edit'), elementButton('delete')],
                ['2', 'Uhoa', '4573232', 'Female', '0.00', elementButton('purchase'), elementButton('view'), elementButton('edit'), elementButton('delete')],
                ['3', 'Jsoae', '6756855', 'Male', '0.00', elementButton('purchase'), elementButton('view'), elementButton('edit'), elementButton('delete')]
...
const styles = StyleSheet.create({
    ...
    purchasebtn: { width: 62, height: 22, backgroundColor: '#00A65A', borderRadius: 3, justifyContent: 'center', alignItems: 'center' },

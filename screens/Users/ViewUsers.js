...
class ViewUsers extends Component {
    constructor(props) {
        ...
        this.state = {
            tableHead: ['Id', 'Name', 'Email', 'Mobile', 'Group', 'Created At', 'Status', 'Profile', 'Edit', 'Delete'],
            widthArr: [40, 60, 200, 60, 100, 80, 60, 100, 100, 100],
            tableData: [
                ['1', 'John', 'john@gmail.com', '1202311', 'Kingdom', '2020-02-22', elementButton('status', 'active'), elementButton('view'), elementButton('edit'), elementButton('delete')],
                ['2', 'Uhoa', 'uhoa@gmail.com', '4573232', 'Freedom', '2020-01-12', elementButton('status', 'inactive'), elementButton('view'), elementButton('edit'), elementButton('delete')],
                ['3', 'Jsoae', 'jsoae@outlook.com', '6756855', 'Happydom', '2020-02-16', elementButton('status', 'active'), elementButton('view'), elementButton('edit'), elementButton('delete')]
...
const styles = StyleSheet.create({
    ...
    statusbtn: { width: 40, height: 18, backgroundColor: '#00a65a', borderRadius: 20 },
